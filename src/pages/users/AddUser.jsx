                            ...
                            <form action={action}>
                                <div className="row row-sm">
                                    <div className="col-sm-4">
                                        ...
                                        <input className="form-control" placeholder="Enter first name" name="firstName" type="text"/>
                                ...
                                <div className="row row-sm">
                                    <div className="col-sm-4">
                                        ...
                                        <input className="form-control" placeholder="Enter last name" name="lastName" type="text"/>
                                ...
                                <div className="row row-sm">
                                    <div className="col-sm-4">
                                        ...
                                        <input className="form-control" placeholder="Enter your age" name="age" type="text"/>
                                ...
                                <div className="row row-sm">
                                    <div className="col-sm-4 pt-4">
                                        <input type="submit" disabled={pending} className="btn btn-primary btn-sm" value="Add User"/> &nbsp;
                                        <Link to="/admin/users">
