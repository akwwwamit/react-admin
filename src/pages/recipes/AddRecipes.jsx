...
let AddRecipes = () => {
    ...
    let handleSuccess=(title, description)=>{
        try {
                    ...
                    <form action={action}>
                        <div className="row row-sm">
                            <div className="col-sm-4">
                                ...
                                <input className="form-control" placeholder="Enter recipe name" name="title" type="text"/>
                        ...
                        <div className="row row-sm">
                            <div className="col-sm-4 pt-2">
                                ...
                                <textarea className="form-control" placeholder="Enter recipe description" name="description" rows="3"></textarea>
                        ...
                        <div className="row row-sm">
                            <div className="col-sm-4 pt-4">
                                <input type="submit" disabled={pending} className="btn btn-primary btn-sm" value="Add Recipe"/> &nbsp;
